...
#shit I've added
from DataLoadingAndValidation import load_and_validate
from Journey_Analysis import analyse_journeys_by_day
...
def main_interface(valid_records):
    while True:
        ...
        if choice == "1":
            ...
            analyse_journeys_by_day(valid_records,str(input('Give day: ')))
        else:
            print("Invalid option. Try again.")

main_interface(load_and_validate())